...
#Uncomment to generate preprocessor listings...
#CFLAGS += -E -dM
...
#Default FUSE settings (in _commonCode/_make/atmega328p.mk) for
# internal R/C clock at 8MHz
FCPU = 8000000UL
...
# Heartbeat is on MISO (Use the defaults)
...
# Polled UAR uses the TCNTER to determine its bit-timing...
...
## DMS_CLKDIV = CLKDIV64 = 6, so 64=(1<<DMS_CLKDIV)
CFLAGS += -D'BIT_TCNT=(((F_CPU)/(1<<_DMS_CLKDIV_)/9600)-1)'
...
# * /home/meh/_commonCode/polled_uar/0.51-gitHubbing/testMega328p/makefile
# *
