...
//0.51 wow, VER_TCNTER was 0.20, we're now at 0.31
//0.50 puar_init() didn't handle setting the pin as an input, etc...
//     as I recall, this is to be implemented similarly to puat
//     puarStuff.h should now include:
//     extern __inline__ uint8_t puar_initInput(uint8_t puarNum)
//
//     NOTE: as far as test-code goes:
//           ONLY ONLY ONLY testMega328p has been tested with this
//                          (and even there, only *compiled*, not *run*)
//
 ...
 * /home/meh/_commonCode/polled_uar/0.51-gitHubbing/testMega328p/_commonCode_localized/polled_uar/0.51-gitHubbing/polled_uar.h
 *
