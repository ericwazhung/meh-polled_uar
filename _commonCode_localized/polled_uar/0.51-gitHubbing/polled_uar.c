...
{
   //This is called from puarStuff.h, in the project-directory...
   puar_initInput(puarNum);
 ...
 * /home/meh/_commonCode/polled_uar/0.51-gitHubbing/testMega328p/_commonCode_localized/polled_uar/0.51-gitHubbing/polled_uar.c
 *
