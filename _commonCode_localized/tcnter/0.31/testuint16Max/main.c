...
#if(TCNTER_SOURCE_OVERFLOW_VAL <= UINT16_MAX)
         if(timerCounter >= TCNTER_SOURCE_OVERFLOW_VAL)
            timerCounter -= TCNTER_SOURCE_OVERFLOW_VAL;
#elif (TCNTER_SOURCE_OVERFLOW_VAL > (UINT16_MAX+1))
 ...
 * /home/meh/_commonCode/polled_uar/0.51-gitHubbing/testMega328p/_commonCode_localized/tcnter/0.31/testuint16Max/main.c
 *
