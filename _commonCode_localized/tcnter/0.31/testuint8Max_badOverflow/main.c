...
#endif
*/
         // Intentionally allowing *normal* uint8_t wraparound for this
         // case... where OVERFLOW_VAL is 0xff (should be 0x100)
         // To test what happens in those cases I've mistakenly used the
         // wrong value...
         timer=0;
 ...
 * /home/meh/_commonCode/polled_uar/0.51-gitHubbing/testMega328p/_commonCode_localized/tcnter/0.31/testuint8Max_badOverflow/main.c
 *
