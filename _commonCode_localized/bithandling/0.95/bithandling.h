...
//       and isbit()...
//       Smart Optimizer... same size (ispinPORT, with constants)
//       Not gonna bother with other is's for now.
//.95-7  adding if_TrueThenValASM()
//       an if-then statement that's guaranteed to be the same number of
//       instructions in either branch.
...
#else //!__AVR_ARCH__
// THIS IS ONLY HERE for cases where e.g. AVR code might be tested on a
// PC... THIS DOES NOT guarantee cycles... AND PROBABLY SHOULDN'T BE USED
 ...
 * /home/meh/_commonCode/polled_uar/0.51-gitHubbing/testMega328p/_commonCode_localized/bithandling/0.95/bithandling.h
 *
