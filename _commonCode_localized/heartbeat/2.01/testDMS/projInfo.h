...
#include <inttypes.h>
 ...
 const uint8_t __attribute__ ((progmem)) \
   header[] = "heartbeatTesttestDMS 2014-05-02 20:27:54";
#else //projInfo Not Shortened nor overridden
 const uint8_t __attribute__ ((progmem)) \
   header0[] = " /Users/meh/_commonCode/heartbeat/1.50/testDMS ";
 const uint8_t __attribute__ ((progmem)) \
   header1[] = " Fri May  2 20:27:54 PDT 2014 ";
 const uint8_t __attribute__ ((progmem)) \
   headerOpt[] = "  ";
#endif
 ...
 * /home/meh/_commonCode/polled_uar/0.51-gitHubbing/testMega328p/_commonCode_localized/heartbeat/2.01/testDMS/projInfo.h
 *
